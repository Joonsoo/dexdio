...
public class DexMethod {
	...
	private MethodKind methodKind; // directmethod이면 true, virtual method이면
									// false
	private DexCodeItem codeitem;

	public static enum MethodKind {
		INHERITED_METHOD, DIRECT_METHOD, VIRTUAL_METHOD
	}

	public DexMethod(DexProgram program, int methodId, com.giyeok.dexdio.dexreader.MethodTable.Method method)
			throws DexException {
